...
> **Для быстрого знакомства с системой** используйте готовые сборки из [релизов](https://github.com/Mitoshi-Team/AI-CyberLogAgent/releases). Клонировать репозиторий и собирать образы вручную имеет смысл только для разработки.
