<template>
  ...
  >
    <!-- Логотип -->
    <div :class="['px-4 sm:px-5 mb-8', isCollapsed ? 'pt-2 overflow-hidden' : 'pt-1 overflow-visible']">
      <div :class="['flex items-center', isCollapsed ? 'justify-center' : 'justify-between']">
        ...
        >
          <img
            ...
            alt="wavescan"
            class="w-8 h-8 ml-1 transition-all duration-200"
          />
        </button>
        <img
          v-else
        ...
        <img
          ...
          alt="wavescan"
          :class="[
            'h-4 ml-2 w-auto whitespace-nowrap transition-all duration-300',
    ...
    <nav class="space-y-2 px-3 mb-8">
      <RouterLink
        ...
        :class="[
          'nav-link',
          isCollapsed ? 'nav-link-collapsed' : 'justify-center sm:justify-start'
        ]"
    ...
    <div :class="['mt-auto py-4 mb-3', isCollapsed ? 'px-3' : 'px-3 sm:px-4']">
      <div 
        :class="[
          'mb-3 pb-3 border-b border-[#2a2d36] transition-all duration-300',
          isCollapsed ? 'opacity-0 h-0 overflow-hidden' : 'opacity-100 hidden sm:block'
        ]"
      >
