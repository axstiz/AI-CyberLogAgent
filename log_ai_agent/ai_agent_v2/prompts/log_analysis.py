...
ВАЖНО: Секция ---EVENTS--- должна содержать ТОЛЬКО подозрительные события,
которые требуют проверки в MITRE ATT&CK. Если событий нет - напиши пустой массив []."""
